...
def export_clip_model():
    ...
    opt_onnx_path = "./onnx/CLIP_opt.onnx"
...
def export_control_net_model():
    ...
    opt_onnx_path = "./onnx/ControlNet_opt.onnx"
...
def export_controlled_unet_model():
    ...
    opt_onnx_path = "./onnx/ControlledUnet_opt"
    os.makedirs(opt_onnx_path, exist_ok=True)
    opt_onnx_path = opt_onnx_path + "/ControlledUnet_opt.onnx"
...
def export_decoder_model():
    ...
    opt_onnx_path = "./onnx/Decoder_opt.onnx"
